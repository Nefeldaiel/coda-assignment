...
public class HealthCheckService {
    ...
    public HealthCheckService(RoutingConfig routingConfig, RequestHandler requestHandler) {
    ...
    public void checkServerHealth(ServerHealth serverHealth) {
        ...
        try {
            logger.debug("Checking health for server: {}", serverUrl);

            // Create health check request model
            HealthCheckRequest healthRequest = HealthCheckRequest.create(serverUrl);

            // Send request through RequestHandler
            ResponseEntity<String> response = requestHandler.sendRequest(healthRequest);
